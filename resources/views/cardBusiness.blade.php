    ...
    <body>
        ...
        <div class="total-container">
            <div>
                <b>
                    <p>Total <abbr
                            title="the prices shown above don't include any applicable taxes. Subscription automatically renews within 24-hours prior to the end of the current period. To cancel auto-renewai, please contact ................"
                            class="mi-abbr">ⓘ</abbr></p>
                </b>
        ...
        <div class="renew">
            <b>
                <p>Auto renews on Nov 30, 2024</p>
            </b>
        </div>
        ...
        <div class="form-container">
            ...
            <div class="field-container">
                <label for="privacy">
                    <input type="checkbox" name="" id="privacy"> I agree to the <a href="">Terms of
